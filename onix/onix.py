    ...
    for sbid in sbidlist:
        ...
        try:
            ...
            if '_id' in book:
                ...
                # Preços
                usd_price = book.get('price_dollar', '').strip()
                brl_price = book.get('price_reais', '').strip()

                # Caso existam os dois preços
                if usd_price and brl_price:
                    # USD
                    price = Element('Price')
